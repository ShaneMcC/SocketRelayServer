<?php
	...
	class DiscordClient extends EventEmitter {
		...
		private function getRequest(String $endpoint, ?Callable $gotResponse = null, String $type = 'GET', Array $headers = []) {
			$headers['User-Agent'] = 'SocketRelayServer/discord (https://github.com/shanemcc/SocketRelayServer, 0.1)';
		...
		private function sendIdentify(int $shard) {
			...
			$identify['properties'] = ['os' => PHP_OS, 'browser' => 'SocketRelayServer/discord', 'library' => 'SocketRelayServer/discord'];
